...
/**
 * A {@code GeneratorPublisher} is a {@link Flow.Publisher} that
...
class GeneratorPublisher<T> implements Flow.Publisher<T> {
    ...
    /**
     * Constructs a new <code>GeneratorPublisher</code> with the specified async generator.
     *
    ...
    /**
     * Subscribes the provided {@code Flow.Subscriber} to this signal. The subscriber receives initial subscription,
     * handles asynchronous data flow, and manages any errors or completion signals.
     *
    ...
    public void subscribe(Flow.Subscriber<? super T> subscriber) {
        subscriber.onSubscribe(new Flow.Subscription() {
             ...
             *
             * <p>The Publisher calls this method to indicate that it wants more items. The parameter {@code n}
             * specifies the number of additional items requested.
             *
